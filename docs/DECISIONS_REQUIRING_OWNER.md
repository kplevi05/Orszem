...
| ~~A7~~ | ~~Give `feature/v2-public-clients` explicit visual approval~~ — **done**, owner approved the round-2 (mockup-aligned) Web + Android screenshots, 2026-09-08 | `PHASE_5_ENGINEERING_REPORT.md` §J/§M | resolved |
| ~~A8~~ | ~~Run the Public Android instrumented test suite on a real device or emulator~~ — **done**, `orszem-test` (API 35), 16/16 instrumented tests pass, 2026-09-08 | `PHASE_5_ENGINEERING_REPORT.md` §H2 | resolved |
