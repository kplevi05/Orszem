...
enum class UiErrorReason {
    VALIDATION, REFERENCE_UNAVAILABLE, NETWORK, RATE_LIMITED, CONFLICT, LOCAL_STORAGE, ACCESS_LOST, GENERIC
}

enum class LocateStatus { IDLE, LOCATING, PERMISSION_DENIED, PERMISSION_PERMANENTLY_DENIED, SERVICES_DISABLED, FAILED, GEOCODER_UNAVAILABLE, TIMEOUT }
