...
export const strings = {
  ...
  homeBadge: 'Gyors műveletek',
  homeHeadline: 'Mit szeretne tenni?',
  homeBody: 'Indíthat új bejelentést, vagy megtekintheti az előzményeket egy átlátható, kártyás felületen.',
  homeNewReportCta: 'Új bejelentés',
  homeQuickNewReportTitle: 'Új bejelentés',
  homeQuickNewReportBody: 'Két lépésben végigvezetett űrlap.',
  homeQuickNewReportCta: 'Indítás',
  homeQuickHistoryTitle: 'Előzmények',
  homeQuickHistoryBody: 'Korábbi bejelentések állapota és adatai.',
  homeQuickHistoryCta: 'Megtekintés',
  homeRecentHistoryTitle: 'Legutóbbi bejelentések',
  homeRecentHistoryCount: (n: number) => `${n} elem`,
